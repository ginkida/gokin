...
// getOutputTokens returns the current response tail. It is estimated while
// text streams and replaced by provider-reported output usage at completion.
...
// input context. outputTokens is the current response tail (estimated while
// streaming, provider-measured at completion); it's shown as a lighter extension
