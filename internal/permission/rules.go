...
func DefaultRules() *Rules {
	return &Rules{
		...
		ToolPolicies: map[string]Level{
			...
			"review_changes":       LevelAllow,
			"go_to_definition":     LevelAllow,
			"find_references":      LevelAllow,
			"history_search":       LevelAllow,
			"tools_list":           LevelAllow,
			"skill":                LevelAllow,
			...
			"kill_shell":           LevelAllow,
			"enter_plan_mode":      LevelAllow,
			"update_plan_progress": LevelAllow,
